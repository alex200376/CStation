jQuery(document).ready(function($) {
    ...
    ProductBuilder.prototype.showNewContent = function(nextStep) {
        ...
        if (actualStep < nextStep + 1) {
            //go to next section
            this.steps.eq(actualStep - 1).removeClass('active back1').addClass('move-left');
            this.steps.eq(nextStep).addClass('active').removeClass('move-left back1');
        } else {
            //go to previous section
            this.steps.eq(actualStep - 1).removeClass('active back1 move-left');
            this.steps.eq(nextStep).addClass('active back1').removeClass('move-left');
        }
    }
